...
const AudioCard = ({ a, admin = false, index }) => {
    ...
    return (
        <div className=" text-left lg:w-[350px] md:w-[300px] whitespace-pre-wrap break-words greenbg rounded-md shadow4 lg:hover:-translate-y-2 active:-translate-y-2 duration-500 ">
            <div className="p-2">
