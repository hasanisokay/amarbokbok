                ...
                <nav className="flex justify-between md:gap-10">
                    <section>
                        ...
                        <ul className="flex items-center my-2 flex-col gap-2 text-[#424242] dark:text-[#e0e0e0]">
                            <li className="lg:hover:scale-110 active:scale-110 lg:after:scale-100"><NavLink activeClasses={"text-[#005494] dark:text-[#1ad93e]"}  href={"/"}>Home</NavLink></li>
                            <li className="lg:hover:scale-110 active:scale-110 lg:after:scale-100"><NavLink activeClasses={"text-[#005494] dark:text-[#1ad93e]"}  href={"/blogs"}>Blogs</NavLink></li>
                            <li className="lg:hover:scale-110 active:scale-110 lg:after:scale-100"><NavLink activeClasses={"text-[#005494] dark:text-[#1ad93e]"}  href={"/about"}>About</NavLink></li>
                            <li className="lg:hover:scale-110 active:scale-110 lg:after:scale-100"><NavLink activeClasses={"text-[#005494] dark:text-[#1ad93e]"}  href={"/contact"}>Contact</NavLink></li>
                        </ul>
                    </section>
                    <section>
