    ...
    return (
        <>
            <div className="shadow3 md:w-[400px] w-full  group lg:hover:-translate-y-2 active:-translate-y-2 duration-500 dark:bg-[#333333] bg-[#b6d7a0] rounded-md group py-4 text-center my-10">
                ...
                <p className="block">Discover all content categories. Simply click on a category to access curated information, articles, and resources that match your preferences.</p>
                <div className="flex py-2 px-1 items-center justify-center flex-wrap gap-4">
